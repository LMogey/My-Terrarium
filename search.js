      ...
      <View style={{ flex: 1 }}>
        ...
        <View >
          <View style={{ flexDirection: 'row', borderWidth: 0.5, borderColor: '#7d90a0', margin: 2, backgroundColor: 'white' }}>
            ...
            <TextInput
              ...
              onChangeText={value => {this.searchUsers(value), this.searchGroups(value)}}
            />
          </View>
        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
          ...
          <View style={{ backgroundColor: '#81ecec', flexDirection:'row', justifyContent:'space-between' }}>
            ...
            <Feather name="map-pin" size={24} color="black" style={{ alignSelf: 'baseline', alignItems: 'baseline', marginRight:3 }} onPress={() => this.props.navigation.navigate('mapPeople')} />
          </View>
        ...
        flexDirection:'row', justifyContent:'space-between'  }}>
            ...
            <Feather name="map-pin" size={24} color="black" style={{ alignSelf: 'baseline', alignItems: 'baseline', marginRight:3 }} onPress={() => this.props.navigation.navigate('mapGroups')} />
          </View>
          <FlatList
