...
import { Container, Content, Tabs, Tab, List, ListItem, DatePicker } from 'native-base';
...
export default function plantsPageAdmin({ navigation, route, props }) {
